  ...
  return (
    <footer className="footer">
      <div className="footer-content">
        ...
        <div className="footer-section">
          ...
          <ul className="social-links">
            <li><a href="https://www.instagram.com/zureeglobal" target="_blank" rel="noopener noreferrer"><FaInstagram /> Instagram</a></li>
            <li><a href="https://wa.me/919711411526" target="_blank" rel="noopener noreferrer"><FaWhatsapp /> WhatsApp</a></li>
            <li><a href="https://www.facebook.com/zureeglobal/" target="_blank" rel="noopener noreferrer"><FaFacebook /> Facebook</a></li>
            <li><a href="https://twitter.com/zureeglobal" target="_blank" rel="noopener noreferrer"><FaTwitter /> Twitter</a></li>
            <li><a href="https://www.linkedin.com/company/zureeglobal" target="_blank" rel="noopener noreferrer"><FaLinkedin /> LinkedIn</a></li>
          </ul>
        </div>
      ...
      <div className="footer-bottom">
        <p>© 2025 Zuree Global. All rights reserved. | <Link to="/terms">Terms & Conditions</Link> | <Link to="/privacy">Privacy Policy</Link></p>
      </div>
    </footer>
  );
}
